...
enum S {
	...
	enum Send {
		...
		static let fee = Localization(key: "Send.fee", value: "**Network Fee: %1$@**", comment: "Network Fee: $0.01")
	...
	enum LitecoinCard {
		static let name = Localization(key: "LitecoinCard.name", value: "**Litecoin Card**", comment: "Card Bar Item Title")
		static let barItemTitle = Localization(key: "LitecoinCard.barItemTitle", value: "**Card**", comment: "Card Bar Item Title")
		static let login = Localization(key: "LitecoinCard.login", value: "**Login**", comment: "Login")
		static let failedlogin = Localization(key: "LitecoinCard.failed.login", value: "**Failed Login**", comment: "Failed Login")
		static let logout = Localization(key: "LitecoinCard.logout", value: "**Logout**", comment: "Logout")
		static let forgotPassword = Localization(key: "LitecoinCard.forgotPassword", value: "**Forgot password?**", comment: "Forgot password?")
		static let resetPassword = Localization(key: "LitecoinCard.resetPassword", value: "**Reset password**", comment: "Reset password")
		static let resetPasswordDetail = Localization(key: "LitecoinCard.resetPasswordDetail", value: "**Enter the email that you used to register for your Litecoin Card and check for an email from support@litecoin.getblockcard.com.**", comment: "Reset password detail")
		static let visitToReset = Localization(key: "LitecoinCard.visit.toReset", value: "**Reset Litecoin card visit**", comment: "Litecoin card visit")
		static let registerCard = Localization(key: "LitecoinCard.registerCard", value: "**Register**", comment: "Register")
		static let registeringUser = Localization(key: "LitecoinCard.registering.user", value: "**Registering user...**", comment: "Registering user...")

		static let cardBalance = Localization(key: "LitecoinCard.cardBalance", value: "", comment: "Card balance")
		static let registrationSuccess = Localization(key: "LitecoinCard.registrationSuccess", value: "", comment: "Registration success")
		static let registrationFailure = Localization(key: "LitecoinCard.registrationFailure", value: "", comment: "Registration failure")
		static let enterCode = Localization(key: "LitecoinCard.enterCode", value: "", comment: "Enter code")
		static let enterCodeDetail = Localization(key: "LitecoinCard.enterCode.detail", value: "", comment: "Enter code details")
		static let twoFAOn = Localization(key: "LitecoinCard.twoFAOn", value: "", comment: "Message when 2FA is on")
		static let twoFAOff = Localization(key: "LitecoinCard.twoFAOff", value: "", comment: "Message when 2FA is off")
		static let cardBalanceOnlyDescription = Localization(key: "LitecoinCard.cardBalanceOnlyDescription", value: "", comment: "Message when 2FA is off and user is viewing the Card Balance")
		static let twoFAErrorMessage = Localization(key: "LitecoinCard.twoFAErrorMessage", value: "2FA Error message", comment: "2FA Error message")

		// MARK: - Disclaimer

		enum Disclaimer {
			static let title = Localization(key: "LitecoinCard.Disclaimer.title", value: "Beta Testing Litecoin Card", comment: "Beta Testing Litecoin Card")
			static let description = Localization(key: "LitecoinCard.Disclaimer.description", value: "Description", comment: "Description of the status")
			static let bullets = Localization(key: "LitecoinCard.Disclaimer.bullets", value: "bullets", comment: "Features and limitations")
			static let referral = Localization(key: "LitecoinCard.Disclaimer.referral", value: "referral", comment: "Referral to the website")
		}

		// MARK: - Transfer

		enum Transfer {
			static let title = Localization(key: "LitecoinCard.Transfer.title", value: "Transfer", comment: "Transfer title")
			static let description = Localization(key: "LitecoinCard.Transfer.description", value: "Choose the transferring wallet", comment: "Description of action")
			static let litewalletBalance = Localization(key: "LitecoinCard.Transfer.litewalletBalance", value: "Litewallet balance", comment: "Litewallet balance label")
			static let amountToCard = Localization(key: "LitecoinCard.Transfer.amountToCard", value: "Transfer to Card", comment: "Transfer to card label")
			static let amountToLitewallet = Localization(key: "LitecoinCard.Transfer.amountToLitewallet", value: "Transfer to Litewallet", comment: "Transfer to Litewallet label")
			static let setAmount = Localization(key: "LitecoinCard.Transfer.setAmount", value: "Slide to set transfer amount", comment: "Set transfer amount label")
			static let startTransfer = Localization(key: "LitecoinCard.Transfer.startTransfer", value: "Start transfer", comment: "Start transfer label")
			static let destinationAddress = Localization(key: "LitecoinCard.Transfer.destinationAddress", value: "Destination address", comment: "Destination address label")
		}

		// MARK: - Registration

		enum Registration {
			static let registerCardPhrase = Localization(key: "LitecoinCard.registerCardPhrase", value: "**Register for Litecoin Card**", comment: "Register for Litecoin Card")
			static let password = Localization(key: "LitecoinCard.Registration.password", value: "", comment: "password")
			static let confirmPassword = Localization(key: "LitecoinCard.Registration.confirmPassword", value: "", comment: "confirm password")
			static let firstName = Localization(key: "LitecoinCard.Registration.firstName", value: "", comment: "First name")
			static let lastName = Localization(key: "LitecoinCard.Registration.lastName", value: "", comment: "Last name")
			static let kycSSN = Localization(key: "LitecoinCard.Registration.kycSSN", value: "", comment: "SSN")
			static let kycIDNumber = Localization(key: "LitecoinCard.Registration.kycIDNumber", value: "", comment: "kycIDNumber")
			static let kycIDType = Localization(key: "LitecoinCard.Registration.kycIDType", value: "", comment: "kycIDType")
			static let address = Localization(key: "LitecoinCard.Registration.address", value: "", comment: "address")
			static let city = Localization(key: "LitecoinCard.Registration.city", value: "", comment: "city")
			static let stateProvince = Localization(key: "LitecoinCard.Registration.stateProvince", value: "", comment: "state province")
			static let country = Localization(key: "LitecoinCard.Registration.country", value: "", comment: "country")
			static let zipPostCode = Localization(key: "LitecoinCard.Registration.zipPostCode", value: "", comment: "zip post Code")
			static let mobileNumber = Localization(key: "LitecoinCard.Registration.mobileNumber", value: "", comment: "mobile number")
			static let identification = Localization(key: "LitecoinCard.Registration.identification", value: "", comment: "identification")

			enum ValidationError {
				static let empty = Localization(key: "LitecoinCard.Registration.ValidationError.empty", value: "Most not be empty", comment: "must not be empty")
				static let numberRequired = Localization(key: "LitecoinCard.Registration.ValidationError.numberRequired", value: "Mobile number required", comment: "Mobile number required")
				static let numberDigitsRequired = Localization(key: "LitecoinCard.Registration.ValidationError.numberDigitsRequired", value: "Mobile number 10 digits required", comment: "Mobile number 10 digits required")
				static let requiredField = Localization(key: "LitecoinCard.Registration.ValidationError.requiredField", value: "Required field", comment: "Required field")
				static let passwordRequired = Localization(key: "LitecoinCard.Registration.ValidationError.passwordRequired", value: "Password required", comment: "Password required")
				static let passwordCharacters = Localization(key: "LitecoinCard.Registration.ValidationError.passwordCharacters", value: "6 password Characters required", comment: "6 Password characters required")
				static let passwordComposition = Localization(key: "LitecoinCard.Registration.ValidationError.passwordComposition", value: "Capital and numeric password characters required", comment: "Captial and numeric password characters required")
				static let invalidEmail = Localization(key: "LitecoinCard.Registration.ValidationError.invalidEmail", value: "Invalid email address", comment: "Invalid email address")
			}
		}
	}
	...
	enum UnlockScreen {
		...
		static let touchIdPrompt = Localization(key: "UnlockScreen.touchIdPrompt", value: "**Unlock your LoafWallet.**", comment: "TouchID/FaceID prompt text")
	...
	enum StartViewController {
		...
		static let message = Localization(key: "StartViewController.message", value: "**The most secure and safest way to use Litecoin.**", comment: "Start view message")
	}
	...
	enum Confirmation {
		...
		static let feeLabel = Localization(key: "Confirmation.feeLabel", value: "**Network Fee:**", comment: "Network Fee: ($1.00)")
		static let shortFeeLabel = Localization(key: "Confirmation.shortFeeLabel", value: "**FEE:**", comment: "Short Network Fee: ($1.00)")
