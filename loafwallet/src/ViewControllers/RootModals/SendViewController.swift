...
class SendViewController: UIViewController, Subscriber, ModalPresentable, Trackable {
    ...
    private func addButtonActions() {
        ...
        donationCell.didTapToDonate = {
            if let dynamicDonate = UIStoryboard(name: "DynamicDonation", bundle: nil).instantiateViewController(withIdentifier: "DynamicDonation") as? DynamicDonationViewController {
