...
class TransactionsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, Subscriber, Trackable {
    ...
    private func configureTransactionCell(transaction: Transaction?, wasSelected _: Bool?, indexPath: IndexPath) -> TransactionTableViewCellv2 {
            ...
            if transaction.direction == .received {
                cell.showQRModalAction = { [unowned self] in
                    ...
                    if let addressString = transaction.toAddress,
                        ...
                        let receiveLTCtoAddressModal = UIStoryboard(name: "Alerts", bundle: nil).instantiateViewController(withIdentifier: "LFModalReceiveQRViewController") as? LFModalReceiveQRViewController {
