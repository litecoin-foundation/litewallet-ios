...
struct C {
    ...
    static let feedbackEmail = "contact@Litewallet.org"
    static let reviewLink = "https://itunes.apple.com/app/Litewallet-litecoin-wallet/id1119332592?action=write-review"
