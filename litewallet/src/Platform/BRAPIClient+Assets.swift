...
//	}
//
//	private func downloadAndPatchArchive(fromVersion: String, completionHandler: @escaping (_ error: Error?) -> Void)
//	{
...
//	}
//
//	private func copyBundledArchive() {
...
//	}
//
//	private func ensureBundlePaths() throws {
//		let fm = FileManager.default
